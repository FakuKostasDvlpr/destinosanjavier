  ...
  return (
    <>
      <section className="relative h-fit mb-10 w-full bg-transparent flex flex-col items-center justify-center overflow-hidden">
        ...
        {/* Image Slider */}
        <a  className="relative w-full max-w-[370px] h-[439px]">
          {songs.map((song, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-center h-fit m-auto mb-40">
                <img
                  src={song.image}
                  alt={song.name}
        ...
        {/* Audio Player */}
        <div className="relative bg-purple-200 rounded-lg w-80 p-3">
          <div className="flex gap-3 items-center space-x-3">
            ...
            <div className="text-purple-700">
              {/* Mostrar la duración de la canción actual */}
              {songs[currentIndex].duration}
            </div>
          </div>
          <div className="mt-2 bg-purple-300 h-1 rounded-full">
            <div className="bg-blue-500 h-full w-4 rounded-full"></div>
          </div>
        </div>
